...
//   // Data Source
//   getIt.registerFactory<UserLoginLocalDatasource>(
//       () => UserLoginLocalDatasource(getIt<HiveService>()));

//   // Repository
//   getIt.registerLazySingleton<UserLoginDomainRepository>(
//       () => UserLoginDataRepositoryImpl(getIt<UserLoginLocalDatasource>()));
...
//   // Data Source
//   getIt.registerFactory<UserSignupLocalDatasource>(
//       () => UserSignupLocalDatasource(getIt<HiveService>()));

//   // Repository
//   getIt.registerLazySingleton<UserSignupDomainRepository>(
//       () => UserSignupDataRepositoryImpl(getIt<UserSignupLocalDatasource>()));

//   // Use Cases
//   getIt.registerLazySingleton<SignupUseCase>(
//       () => SignupUseCase(getIt<UserSignupDomainRepository>()));
//   getIt.registerLazySingleton<GetUserByEmailUseCase>(
//       () => GetUserByEmailUseCase(getIt<UserSignupDomainRepository>()));
//   getIt.registerLazySingleton<IsEmailRegisteredUseCase>(
//       () => IsEmailRegisteredUseCase(getIt<UserSignupDomainRepository>()));
//   getIt.registerLazySingleton<DeleteUserUsecase>(
//       () => DeleteUserUsecase(getIt<UserSignupDomainRepository>()));
// }
